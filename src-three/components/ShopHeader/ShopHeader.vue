<template>
  <div class="shop-header">
    ...
    <div class="shop-content">
      ...
      <div class="header-content" @click="isBulletin = true">
    ...
    <div class="shop-header-discounts" v-if="info.supports" @click="isSupports = true">
    ...
    <div class="shop-brief-modal" v-show="isBulletin">
      <div class="brief-modal-content">
        ...
        <div class="mask-footer">
          <span class="iconfont icon-close" @click="isBulletin = false"></span>
        </div>
      </div>
    ...
    <div class="activity-sheet" v-show="isSupports">
      <div class="activity-sheet-content">
        <h2 class="activity-sheet-title">
          优惠活动</h2>
        <ul class="list">
          <li class="activity-item activity-green" v-for="(support,index) in info.supports" :key="index" :class="activityClass[support.type]">
            <span class="content-tag">
        ...
        <div class="activity-sheet-close">
          <span class="iconfont icon-close" @click="isSupports = false"></span>
        </div>
      </div>

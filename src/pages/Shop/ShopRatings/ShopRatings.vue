<template>
  <div class="ratings">
    <div class="ratings-content">
      ...
      <RatingFilters :selectType="selectType" :onlyContent="onlyContent"
                     @setSelectType="setSelectType"
                     @toggleRatingContent="toggleRatingContent"/>
    ...
    computed: {
      ...
      filterRatings(){
        ...
        return ratings.filter(rating =>{
          ...
          return (selectType === 2 || selectType === rateType) && (!onlyContent || text.length)
        })
      }
    },
    methods: {
